...
//     ;
    ...
    function actualDataPointsColor(d,i){
        let color;
        if (d[1][0].emotionalContent == "enjoyment") {
            color = "#F5B041";
        } else if (d[1][0].emotionalContent == "anger") {
            color = "#E74C3C";
        } else if (d[1][0].emotionalContent == "disgust") {
            color = "#AF7AC5";
        } else if (d[1][0].emotionalContent == "sadness") {
            color = "#85C1E9";
        } else if (d[1][0].emotionalContent == "Questioning") {
            color = "#A3E4D7";
        } else if (d[1][0].emotionalContent == "none") {
            color = "#ABB2B9";
        } else if (d[1][0].emotionalContent == "fear") {
            color = "#566573";
        } else if (d[1][0].emotionalContent == "surprise/shock") {
            color = "#F7DC6F";
        }
        // console.log(color);
        return color;
    ...
    let actualDataGroups = hourDataGroups.append("g")
        ...
        .attr("transform", function(d, i){
            ...
            // let dataOrder;
            console.log(d[1].length);//the number of the data point of each hour
            // if order==0,1,2,3, return rotation 0,5,10,15
    ...
    actualDataGroups
        .filter(function(d, i) { return d[1][0].toWhom == "friend"; })
        .append("rect")
            .attr("x",-5)
            .attr("y",0)
            .attr("width",20)
    ...
    actualDataGroups.append("circle")
        .filter(function(d, i) { return d[1][0].toWhom == "roommate"; })
            .attr("cx", 0)
            .attr("cy", 0)
            .attr("r", 8)
    ;
    ...
    actualDataGroups.append("circle")
        .filter(function(d, i) { return d[1][0].toWhom == "strangers"; })
            .attr("cx", 0)
            .attr("cy", 0)
            .attr("r", 8)
    ;
    ...
    actualDataGroups
        .filter(function(d, i) { return d[1][0].toWhom == "acquaintance"; })
        .append("rect")
            .attr("x",0)
            .attr("y",0)
            .attr("rx",4)
    ...
    actualDataGroups
        .filter(function(d, i) { return d[1][0].toWhom == "family"; })
